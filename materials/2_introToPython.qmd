...
Literals are fixed values written directly in your code. They include numbers, strings, booleans, and more.  
Literals are used to assign values to variables or as standalone values in expressions.
...
Variables store data for use in your program. Operators let you perform operations like addition, comparison, and assignment.
