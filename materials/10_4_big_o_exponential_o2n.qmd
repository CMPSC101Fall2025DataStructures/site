...
## The "Branching Recursion" Pattern 🌳
...
<div id="password-demo" style="text-align: center; margin: 20px 0;">
    <!-- <h3>Password Strength - Exponential Security</h3> -->
     <h3> Exponential Security Growth! 🛡️ </h3>
    <div style="margin: 20px 0;">
...
```python
    ...
    def power_set(items):
        ...
        first = items[0]
        rest_subsets = power_set(items[1:])  # Recursive call
        
        # Each element doubles the possibilities
    ...
    if len(visited) == len(cities):
        return path + [0], calculate_distance(path + [0])
...
**fibonacci_slow(40) = ~2 billion function calls!** That's why we need better algorithms for recursive problems.🎯
:::
...
## Final Challenge: Algorithm Detective! 🕵️‍♂️

::: {.callout icon="true"}
## Can You Identify These Complexities Part 1? 🧩

Mystery Algorithms: Put Your Skills to the Test! 🤔
...
function initializePasswordDemo() {
    ...
    function drawChart() {
        ...
        ctx.font = '10px Arial';
        ctx.textAlign = 'left';
        ctx.fillText('📊 Combinations | ⏱️ Crack Time | 🎯 Current Selection', 10, canvas.height - 50);
    }
